...
class Trader:
    ...
    def calculate_fair_value(
        ...
        # Calculate fair value as average of bid and ask VWAPs over the window
        if len(traderObject[f"{product}_price_data"]) >= window_size:
            ...
            # Fair value is the midpoint of the average bid and ask VWAPs
            fair_value = (avg_bid_vwap + avg_ask_vwap) / 2
        else:
            # Not enough data yet, use simple midpoint
