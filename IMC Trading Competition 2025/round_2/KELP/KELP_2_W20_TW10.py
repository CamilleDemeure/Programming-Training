...
PARAMS = {
    Product.KELP: {
        ...
        "take_width": 10,              # Distance from fair value to capture mispriced orders; increased for wider capture
        ...
        "soft_position_limit": 35,    # Conservative position management target, lower than hard limit (50)
