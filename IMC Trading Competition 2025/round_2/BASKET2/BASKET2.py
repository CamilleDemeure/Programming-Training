...
PARAMS = {
    Product.PICNIC_BASKET2: {
        ...
        "tier1_distance": 2,        # Changed from 1 to 2
        "tier2_distance": 4,        # Changed from 2 to 4
        "tier3_distance": 7,        # Changed from 3 to 7
    ...
    def run(self, state: TradingState):
        ...
        if Product.PICNIC_BASKET2 in self.params and Product.PICNIC_BASKET2 in state.order_depths:
            ...
            result[Product.PICNIC_BASKET2] = (
                PICNIC_BASKET2_take_orders_PICNIC_BASKET2 + PICNIC_BASKET2_clear_orders_PICNIC_BASKET2 + PICNIC_BASKET2_make_orders
            )
