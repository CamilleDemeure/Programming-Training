...
PARAMS = {
    Product.PICNIC_BASKET2: {
        ...
        "aggressiveness": 1,          # Significantly reduced for safer approach
        ...
        "tier1_volume_pct": 0,        # Reduced allocation to closest tier
        "tier2_volume_pct": 0,       # Increased middle tier allocation
        "tier3_volume_pct": 1,       # Increased furthest tier allocation
    ...
    def run(self, state: TradingState):
        ...
        if Product.PICNIC_BASKET2 in self.params and Product.PICNIC_BASKET2 in state.order_depths:
            ...
            result[Product.PICNIC_BASKET2] = (
                PICNIC_BASKET2_make_orders#+PICNIC_BASKET2_take_orders + PICNIC_BASKET2_clear_orders #+ PICNIC_BASKET2_make_orders
            )
