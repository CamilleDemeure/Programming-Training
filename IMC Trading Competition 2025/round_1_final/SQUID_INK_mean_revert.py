...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if Product.SQUID in state.order_depths:
            ...
            position = state.position.get(Product.SQUID, 0)
            ...
            if fair_value is None and order_depth.buy_orders and order_depth.sell_orders:
                ...
                next_bid = bid_vwap + self.params[Product.SQUID]["bid_offset"]
                next_ask = ask_vwap + self.params[Product.SQUID]["ask_offset"]
            ...
            if fair_value is not None and next_bid is not None and next_ask is not None:
                ...
                squid_orders.extend(opportunity_orders)
                buy_volume += buy_vol
                ...
                squid_orders.extend(make_orders)
